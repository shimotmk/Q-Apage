...
if (count($errors) === 0){
	...
	$url = "http://tt-458b.99sv-coco.com/registration_form.php"."?urltoken=".$urltoken;
	//ここでデータベースに登録する
	try{
		//例外処理を投げる（スロー）ようにする
	...
	$returnMail = 'qandatouroku@eay.jp';
 
	$name = "Q&Aページ";
	$mail = 'qandatouroku@eay.jp';
	$subject = "【Q&A】会員登録用URLのお知らせ";
...
EOM;
	...
	//Fromヘッダーを作成
	$header = 'From:qandatouroku@eay.jp' . mb_encode_mimeheader($name). ' <' . $mail. '>';
